...
exports.router = t.router; // 👈 `router` is the same as `appRouter` in the backend
exports.publicProcedure = t.procedure; // for public api access
exports.privateProcedure = t.procedure.use(isAuth); // for private api access
