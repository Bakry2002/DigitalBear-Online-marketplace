            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, payload_1.getPayloadClient)()];
                    case 1:
                        payload = _b.sent();
                    ...
                    case 2:
                        ...
                        filteredProducts = products.filter(function (product) { return Boolean(product.priceId); } // if priceId exists, then it is a paid product
                        );
                    ...
                    case 6:
                        error_1 = _b.sent();
                        console.log(error_1);
                        return [2 /*return*/, { url: null, error: error_1 }];
