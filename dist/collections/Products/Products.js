...
var addUser = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            user = req.user;
            return [2 /*return*/, __assign(__assign({}, data), { user: user.id })]; // add the user id to the product
        });
    });
};
exports.Products = {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, updated]; // return the updated data
                        case 2:
    ...
    fields: [
        ...
        },
        {
            name: "priceId",
            access: {
                create: function () { return false; }, // neither admin nor user can create this field, but developer can with overrideAccess in the config
